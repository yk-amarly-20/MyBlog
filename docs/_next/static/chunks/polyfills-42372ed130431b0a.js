!(function () {
        ...
        n = (function (t) {
          ...
          if (ur(t)) {
            for (var e = t.length, r = [], n = 0; n < e; n++) {
              ...
              "string" == typeof o
                ? eh(r, o)
                : ("number" != typeof o && "Number" !== E(o) && "String" !== E(o)) ||
                  eh(r, Wr(o));
            }
            var i = r.length,
              a = !0;
  ...
  if (u && T(yh) && (!("description" in mh) || void 0 !== yh().description)) {
    var bh = {},
      wh = function () {
        var t =
            arguments.length < 1 || void 0 === arguments[0] ? void 0 : Wr(arguments[0]),
  ...
  var Vg = Error,
    ...
    Zg = !a(function () {
      var t = new Error("a");
      return (
        !("stack" in t) || (Object.defineProperty(t, "stack", d(1, 7)), 7 !== t.stack)
      );
    }),
