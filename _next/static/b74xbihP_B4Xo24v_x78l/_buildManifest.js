(self.__BUILD_MANIFEST = (function (s, e, a, t, c) {
  return {
    __rewrites: {
      ...
      beforeFiles: [
        {
          has: void 0,
          source: "/YOUR_REPO_NAME//_next/:path+",
          destination: "/YOUR_REPO_NAME/_next/:path+",
        },
      ],
      fallback: [],
    },
    ...
    "/articles/[slug]": [
      ...
      "static/chunks/pages/articles/[slug]-a66209787749f9a9.js",
    ],
    "/tags/[tagName]": [
      e,
      c,
  ...
  1e-4,
  NaN,
  "static/chunks/778-2e6f599f11b7fccd.js",
)),
